...
| RESONANCE_086 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-70CFEEC9F1F82156` | `1>0 LOCKED` |
| RESONANCE_087 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-1429FC7AB71D484B` | `1>0 LOCKED` |
| RESONANCE_088 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-5A0697BDCCF8713D` | `1>0 LOCKED` |
| RESONANCE_089 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-4BA2039C98B04060` | `1>0 LOCKED` |
| RESONANCE_090 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-23F5E9CE9DADF8E6` | `1>0 LOCKED` |
| RESONANCE_091 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-B3F6C6D2598469CF` | `1>0 LOCKED` |
| RESONANCE_092 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-D54AC6A8AFDCC99C` | `1>0 LOCKED` |
| RESONANCE_093 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-88942770FD27A91C` | `1>0 LOCKED` |
| RESONANCE_094 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-298D771E9394A701` | `1>0 LOCKED` |
| RESONANCE_095 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-6BCE8566313EF511` | `1>0 LOCKED` |
| RESONANCE_096 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-4BD1E12BF568F748` | `1>0 LOCKED` |
| RESONANCE_097 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-EA4B4AE86E30199A` | `1>0 LOCKED` |
| RESONANCE_098 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-FBE8D04CEAA57C74` | `1>0 LOCKED` |
| RESONANCE_099 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-1CF05F07CF04BD2B` | `1>0 LOCKED` |
| RESONANCE_100 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-231F18298274DC86` | `1>0 LOCKED` |
| RESONANCE_101 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-EFDC1E2BA93069D8` | `1>0 LOCKED` |
| RESONANCE_102 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-9C4F751F6DBB9A8A` | `1>0 LOCKED` |
...
| RESONANCE_110 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-469765BFB0B1F9AA` | `1>0 LOCKED` |
| RESONANCE_111 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-C7E97A0E053391B4` | `1>0 LOCKED` |
| RESONANCE_112 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-569982E96166365B` | `1>0 LOCKED` |
| RESONANCE_113 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-BF12F82C3283D236` | `1>0 LOCKED` |
| RESONANCE_114 | Polska ROI 1999 (Numpsa) | Kosmologia Tolteków (Castaneda) | **0.9589** | `NUMPSA-TOKEN-87BEFB1AE6392E52` | `1>0 LOCKED` |
| RESONANCE_115 | M-Teoria (Superstruny) | Pamięć Klastrowa Wody (Częstotliwości) | **0.9554** | `NUMPSA-TOKEN-BEF7FCB629BA793F` | `1>0 LOCKED` |
| RESONANCE_116 | Polska ROI 1999 (Numpsa) | Kosmologia Wedyjska (Dźwięk Pierwotny) | **0.9818** | `NUMPSA-TOKEN-C8CADB5FFBE3472B` | `1>0 LOCKED` |
| RESONANCE_117 | Kosmologia Kwantowa | Buddyjska Pustka (Śunjata) | **0.9495** | `NUMPSA-TOKEN-95FE868E707F4837` | `1>0 LOCKED` |
