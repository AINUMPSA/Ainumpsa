...
def check_gniazdo(Phi, grad_Phi, epsilon=0.1):
    # ZMIANA: Szukamy wartości BLISKICH zera, nie równych zero
...
def update_attractor(A_old, n):
    # Atraktor rośnie wykładniczo z liczbą gniazd
    return min(A_old + CONFIG["gamma_attractor"] * (1 - A_old) * n, 1.0)

def main():
    print("🚀 AINUMPSA - Core Engine FINAL v1.0")
    print("============================================================")
    A, events, total = 0.0, [], 0
    N = 1000
    print(f"Symulacja {N} zdarzeń LHC...")
    print("Szukam gniazd (Phi bliskie zera)...")
